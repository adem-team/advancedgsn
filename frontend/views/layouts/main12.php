...
use frontend\assets\AppAssetgosendfront;
//use frontend\widgets\Alert;

/* @var $this \yii\web\View */
/* @var $content string */

AppAssetgosendfront::register($this);
?>
<?php $this->beginPage() ?>
<!DOCTYPE html>
    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Gosend</a> 
            </div>
           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    <img src="assets/gsn11/img/find_user.png" class="user-image img-responsive"/>
					</li>
